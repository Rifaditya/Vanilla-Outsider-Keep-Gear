...
Le fichier de configuration est situé dans `.minecraft/config/vanilla-outsider-keep-gear.json`. Compatible Mod Menu et YACL.
...
## 💔 💔 Pénalités d'Usure de Durabilité
...
- [[💔 Durabilité et Pénalités|fr_fr-Durability-and-Penalties]]
