...
Keep Gear menyediakan rangkaian perintah Brigadier di bawah `/keepgear`. Pengecekan status terbuka untuk semua pemain, sedangkan pengaturan konfigurasi memerlukan izin OP level 2.
